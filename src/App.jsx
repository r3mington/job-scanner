  ...
  if (loading) {
    return (
      <div className="flex flex-col min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-950">
        ...
        <p className="text-slate-500 text-sm">Initializing VeritasRecruit...</p>
      </div>
    );
  }
        ...
        <div className="max-w-screen-md mx-auto px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={signOut}
              title="Log Out"
              className="p-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 hover:text-red-500 rounded-lg transition-colors"
            >
